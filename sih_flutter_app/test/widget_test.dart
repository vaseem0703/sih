...
void main() {
  ...
  test('Preserves lesson and topic context across materials', () {
    final generator = CurriculumGeneratorService();
    final topic = CurriculumData.curriculum[2]!['Mathematics']![1]; // Addition Within 10
    final lesson = generator.generateLessonPlan(
      grade: 2,
      subject: 'Mathematics',
      topic: topic,
  ...
  testWidgets('LessonsScreen Start Lesson navigates directly to TeachingPackageScreen',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: LessonsScreen(ttsService: TtsService()),
      ),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets('GeneratedLessonScreen renders and links to Worksheet & Flashcards',
      (WidgetTester tester) async {
    final generator = CurriculumGeneratorService();
    final topic = CurriculumData.curriculum[1]!['Mathematics']![0];
    final lesson = generator.generateLessonPlan(
  ...
  testWidgets('Responsive Layout test on narrow 320px screen across all curriculum screens without RenderFlex overflow',
      (WidgetTester tester) async {
    ...
    final g3EvsTopic = CurriculumData.curriculum[3]!['EVS']![0]; // Clean Water and Air
    ...
    final g2MathTopic = CurriculumData.curriculum[2]!['Mathematics']![2]; // Numbers up to 100
